...
public class Player : MonoBehaviour {
    ...
    private Vector3[] collectionButtonWorldCorners;
    ...
    private void Start()
    {
        ...
        collectionButtonWorldCorners = new Vector3[4];
        collectionButton.GetComponent<RectTransform>().GetWorldCorners(collectionButtonWorldCorners);
    ...
    private void Update()
    {
        ...
        if (!gameRunning && Input.GetMouseButtonDown(0))
        {
            ...
            else if (IsClickOnCollectionButton(mouseWorldPos))
            {
                levelManager.LoadLevel("Collection");
            }
            else
            {   
    ...
    private bool IsClickOnCollectionButton(Vector3 worldPos)
    {
        Vector3 bottomLeft = collectionButtonWorldCorners[0];
        Vector3 topRight = collectionButtonWorldCorners[2];
